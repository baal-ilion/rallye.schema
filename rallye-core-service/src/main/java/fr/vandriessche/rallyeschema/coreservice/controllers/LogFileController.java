...
import fr.vandriessche.rallyeschema.coreservice.services.LogFileService;
...
public class LogFileController {
	...
	public static final String DEFAULT_SOURCE = "mobileChallenge";
	@Autowired
	...
	@PostMapping(URL)
	public String uploadLogFile(@RequestParam(defaultValue = "mobileChallenge") String source, @RequestParam Integer team,
