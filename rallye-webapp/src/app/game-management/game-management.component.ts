...
export class GameManagementComponent implements OnInit, OnDestroy {
  ...
  private readonly SelectedTeamStorageKey = 'GameManagementComponent.selectedTeamId';
  ...
  async onTeamNumberInput(value: string): Promise<void> {
    ...
    if (!valid) {
      ...
      this.challengeNumberInput = '';
      this.challengeFilter = undefined;
      return;
    }
    ...
    if (this.selectedTeamId) {
      ...
      this.onChallengeNumberInput(this.challengeNumberInput);
    } else {
      sessionStorage.removeItem(this.SelectedTeamStorageKey);
      this.challengeNumberInput = '';
      this.challengeFilter = undefined;
  ...
  onChallengeNumberInput(value: string): void {
    this.challengeNumberInput = value as any;
    if (!this.selectedTeamId) {
      this.challengeNumberInput = '';
      this.challengeFilter = undefined;
      return;
    ...
    this.challengeFilter = Number.isFinite(num) ? num : undefined;
  }
