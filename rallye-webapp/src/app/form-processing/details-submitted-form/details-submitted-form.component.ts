...
import { FormTemplate } from 'src/app/form-recognition/common/details-template/models/form-template';
import { Point } from 'src/app/form-recognition/common/details-template/models/point';

@Component({
  selector: 'app-details-submitted-form',
  templateUrl: './details-submitted-form.component.html',
  styleUrls: ['./details-submitted-form.component.scss']
})
export class DetailsSubmittedFormComponent implements OnInit, OnChanges, OnDestroy {
  ...
  loadTemplate(fileUpload) {
    ...
    const href = fileUpload?._links?.submittedForm?.href || fileUpload?._links?.submittedFormThumbnail?.href;
    if (href) {
